...
/* -----------------------------------------------------------------------------*/
   ...
   /* setTimeout(() => {
    ...
    $(document).on('click','[data-dismiss="modal"]',function(e){
        ...
        if($('#wrapper.hidden_overflow').length > 0) {
            $('#wrapper').removeClass('hidden_overflow');
        }
    });
    ...
    $(document).on('click','[data-toggle="modal"]',function(e){
        ...
        if(data_target == "#uiModal") {
            $('#wrapper').addClass('hidden_overflow');
        }
    });
    ...
    $(document).ready(function(){
		...
		$(".header-right .lang > a").click(function(e){
		  ...
		  if($("header-right li").find("a.active").attr('href')!='#') {
            ...
            $(".header-right .navmenu-links li a").removeClass("active");
			  $(this).addClass("active");
		});
		$(".has-level-menu .dropdown-content .row h3 span").click(function(){
			$(this).closest(".dropdown-content").hide()
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    function adjustButtonSize() {
        buttons.forEach(button => {
            ...
            const naturalHeight = button.scrollHeight;
            if (naturalHeight > 50) {
    ...
    buttons.forEach(button => {
        button.addEventListener('input', adjustButtonSize);
    });
});